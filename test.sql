...
(
    ...
    user_tentwale_id int not null,
    tentwala_item_pic char(255) null,
...
(
    ...
    booked_to datetime  null default CURRENT_TIMESTAMP,
    delivery_email varchar(50)  null default 'test@gmail.com',
    delivery_address varchar(100)  null default 'sbi colony',
    delivery_phone varchar(20)  null default '9999999999',
...
(
    ...
    booked_quantity int null default 0,
